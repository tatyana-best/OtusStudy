<?php
define('C_REST_CLIENT_ID','local.693d1be09d2283.67836078');//Application ID
define('C_REST_CLIENT_SECRET','TxpdaNa0dLnbRxePav0UTBz5jCiQtsl1ATiwJiLC70AOUG5gAQ');//Application key
// or
