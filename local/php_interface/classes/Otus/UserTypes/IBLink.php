...
class IBLink
{
    ...
    public static function GetPublicViewHTML($arProperty, $arValue, $strHTMLControlName)
    {
        ...
        $strResult = '';
        $strResult = '<a style="color:red;"' . ($arSettings["_BLANK"] == 'Y' ? 'target="_blank"' : '') . ' href="' . trim($arValue['VALUE']) . '">' . (trim($arVals[$arValue['VALUE']]) ? trim($arVals[$arValue['VALUE']]) : trim($arValue['VALUE'])) . '</a>';
        return $strResult;
    }
    ...
    public static function GetAdminListViewHTML($arProperty, $arValue, $strHTMLControlName)
    {
        ...
        $strResult = '';
        $strResult = '<a style="color:blue;"' . ($arSettings["_BLANK"] == 'Y' ? 'target="_blank"' : '') . ' href="' . trim($arValue['VALUE']) . '">' . (trim($arValue['DESCRIPTION']) ? trim($arValue['DESCRIPTION']) : trim($arValue['VALUE'])) . '</a>';
        return $strResult;
    }
    ...
    public static function GetPropertyFieldHtml($arProperty, $arValue, $strHTMLControlName)
    {
        ...
        if ($_REQUEST['mode'] == 'frame') {
            ...
            $strResult .= '<select style="background:green;" id="pro' . $inpid . '">';
